                ...
                <header className={headerClass.join(' ')}>
                    <div className="m-header">
                        ...
                        <a href={DEMO.BLANK_LINK} className="b-brand">
                            ...
                            <span className="b-title">Self Assesment and Report</span>
                        </a>
                    </div>
...
const mapStateToProps = state => {
    return {
        ...
        headerBackColor: state.reducerStore.headerBackColor,
        headerFixedLayout: state.reducerStore.headerFixedLayout,
