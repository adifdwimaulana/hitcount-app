...
const mapStateToProps = state => {
    return {
        ...
        preLayout: state.reducerStore.preLayout,
        collapseMenu: state.reducerStore.collapseMenu,
        layoutType: state.reducerStore.layoutType,
        navBackColor: state.reducerStore.navBackColor,
        navBackImage: state.reducerStore.navBackImage,
        navIconColor: state.reducerStore.navIconColor,
        navBrandColor: state.reducerStore.navBrandColor,
        layout6Background: state.reducerStore.layout6Background,
        layout6BackSize: state.reducerStore.layout6BackSize,
        rtlLayout: state.reducerStore.rtlLayout,
        navFixedLayout: state.reducerStore.navFixedLayout,
        boxLayout: state.reducerStore.boxLayout,
        navDropdownIcon: state.reducerStore.navDropdownIcon,
        navListIcon: state.reducerStore.navListIcon,
        navActiveListColor: state.reducerStore.navActiveListColor,
        navListTitleColor: state.reducerStore.navListTitleColor,
        navListTitleHide: state.reducerStore.navListTitleHide
    }
};
